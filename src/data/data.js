...
export const everyDollarData = [
  {
    id: 1,
    title: "250+ Partners and growing",
    text: "Our Tax Partnership program grows every year. We've created a network of self employed entrepreneurs living out their dreams every day working a few months a year.",
  },
  {
    id: 2,
    title: "Constant flow of clients",
    text: "Taxes are the most consistent event in modern history. Every year millions of people file their taxes and millions are always looking for some one to trust through the process.",
  },
  {
    id: 3,
    title: "Work on your own schedule",
    text: "You create your own schedule because you are your own boss. Create the freedom to work from any where at any time.",
  },
  {
    id: 4,
    title: "Build wealth at your pace",
    text: "Want to grow beyond a Tax Partner? We have a few ways to help boost your eagerness to grow. Let's grow together.",
  },
];
    ...
    text: [
      {
        id: 1,
        item: "Tax Calculator",
        link: "/tax-witholding-calculator-tool",
      },
      { id: 2, item: "Track my Refund", link: "/refund-status" },
      { id: 3, item: "FAQ", link: "/faq" },
      {
        id: 4,
        item: "Tax Partner Class Real Time",
        link: "/tax-partner-class-real-time",
      },
      {
        id: 5,
        item: "Tax Partner Installment Payments",
        link: "/tax-partner-installment-payments",
      },
    ],
  },
  {
    ...
    title: "Company",
    text: [
      { id: 1, item: "About Us", link: "/about" },
      { id: 2, item: "Contact Us", link: "/contact-us" },
      { id: 3, item: "Privacy Policy", link: "/privacy-policy" },
